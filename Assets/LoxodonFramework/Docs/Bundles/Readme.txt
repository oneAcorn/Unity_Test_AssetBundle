...
NOTES:
------------------------
If you want to use it with Loxodon.Framework 2.x, please import Loxodon.Framework.Bundle For 2.x.unitypackage, the default package conflicts with Loxodon.Framework 2.x.

如果要在Loxodon.Framework 2.x 版本中使用本插件，请单独导入 Loxodon.Framework.Bundle For 2.x.unitypackage，默认包和2.x版本的框架包有冲突


UPDATE NOTES
----------------------------------------
version 1.9.10
	Fixed the bug of redundancy analysis on Unity2020.

version 1.9.8
	Fixed the bug of redundancy analysis on Unity2019.

version 1.9.6
    Fixed a bug that the crash caused by WaitForSecondsRealtime in the version below Unity2018.
	Added async and await feature for unity's coroutines,CustomYieldInstruction,YieldInstruction,AsyncOperation,IAsyncResult,IAsyncResult,etc.
...
version 1.9.5
	...
	Fixed the bug that loading stopped when Time.timeScale = 0.
