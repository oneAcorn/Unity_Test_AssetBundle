...
#pragma warning disable 0414, 0219
    public class RedundancyAnalysisPanel : Panel
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            {
                EditorGUI.ProgressBar(new Rect(rect.x, rect.y, rect.width, 20), progressBar.Progress, "Loading AssetBundle, please wait.");
            }
...
#if UNITY_2020_1_OR_NEWER
            int progressId = Progress.Start("Loading AssetBundle");
#endif
...
#if UNITY_2020_1_OR_NEWER
                Progress.Report(progressId, progressBar.Progress);
#endif
