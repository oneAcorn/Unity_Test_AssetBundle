...
namespace Loxodon.Framework.Bundles
{
    ...
    public class BundleInfo : ISerializationCallbackReceiver
    {
        ...
        public BundleInfo(string name, string variant, Hash128 hash, uint crc, long fileSize, string filename) : this(name, variant, hash, crc, fileSize, filename, false, null, null, false)
        {
        }
        ...
        public BundleInfo(string name, string variant, Hash128 hash, uint crc, long fileSize, string filename, string[] assets) : this(name, variant, hash, crc, fileSize, filename, false, assets, null, false)
        {
        }
        ...
        public BundleInfo(string name, string variant, Hash128 hash, uint crc, long fileSize, string filename, bool published, string[] assets, string[] dependencies, bool streamedScene)
        {
            ...
            this.streamedScene = streamedScene;
        ...
        /// </summary>
        public bool IsStreamedScene { get { return streamedScene; } }
